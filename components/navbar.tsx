...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed left-0 top-0 z-50 bg-[rgba(10,10,10,0.7)] backdrop-blur-md w-full h-24 flex justify-between items-center px-6 md:px-12">
      ...
      <div
        className={`fixed top-0 right-0 w-full h-screen bg-surface z-9990 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
